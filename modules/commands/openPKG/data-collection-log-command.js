...
class DataCollectionLogCommand extends PipelineCommand {
    constructor(ctx) {
        super(ctx);
    ...
    async executeTask(command) {
        ...
        forked.on('message', async (response) => {
            ...
            let { data } = objects;
            data.body = { status: data.body.status };
...
module.exports = DataCollectionLogCommand;
